        ...
        <div class="navbar-nav">
         ...
         <div class="navbar-nav ml-auto">
            <?php if(isset($_SESSION['user_name'])) {
                    ...
                    echo '<a href="../register/register.php?visit=<?php echo $link; ?>" class="nav-item nav-link">Register</a>
                            <a href="../login/login.php?visit=<?php echo $link; ?>" class="nav-item nav-link">Login</a>';
                }
            ?>
        </div>
    </div>
