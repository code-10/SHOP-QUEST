        ...
        <div class="navbar-nav">
         ...
         <div class="navbar-nav ml-auto">
            <?php if(isset($_SESSION['user_name'])) {
                    ...
                    echo '<a href="../register/register.php?visit=<?echo $_SERVER['HTTP_REFERER'];?>" class="nav-item nav-link">Register</a>
                            <a href="../login/login.php?visit=<?echo $_SERVER['HTTP_REFERER'];?>" class="nav-item nav-link">Login</a>';
                }
            ?>
        </div>
    </div>
