	...
	<?php if($stock_variant!="yes") { ?>	
		...
		<?php } else if($stock_variant=="yes") { ?>
			...
			<?php
				...
				echo $variant_approve_variant_id;echo "<br>";
				$variant_approve_size=$_GET['variant_size_v'];
				echo $variant_approve_size;echo "<br>";
				$variant_approve_color=$_GET['variant_color_v'];
				echo $variant_approve_color;echo "<br>";
				$variant_approve_price=$_GET['variant_price_v'];
				echo $variant_approve_price;echo "<br>";
				$variant_approve_quantity=$_GET['variant_quantity_v'];
				echo $variant_approve_quantity;echo "<br>";
				$variant_approve_store_product_id=$_GET['variant_store_product_id_v'];
				echo $variant_approve_store_product_id;echo "<br>";
				$variant_approve_store_info_id=$_GET['variant_store_info_id_v'];
				echo $variant_approve_store_info_id;echo "<br>";
							...
							<div class="col-12 col-sm-4">
								<div class="card border-dark m-4">
  									<div class="card-body">
										...
										<a class="btn btn-success btn-sm" href="sell_request.php?sell_request_main=yes&&status=1&&stock_variant=yes&&variant_approve=yes&&variant_id_v=<?=$variant_id_v[$vi]?>&&variant_color_v=<?=$variant_color_v[$vi]?>&&variant_size_v=<?=$variant_size_v[$vi]?>&&variant_price_v=<?=$variant_price_v[$vi]?>&&variant_quantity_v=<?=$variant_quantity_v[$vi]?>&&variant_store_product_id_v=<?=$variant_store_product_id_v[$vi]?>&&variant_store_info_id_v=<?=$variant_store_info_id_v[$vi]?>" role="button">Approve Variant</a>
