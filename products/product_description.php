		    ...
		    <div class="row">
			    ...
			    <div class="col-6">
				    <?php if($addtocart=="yes")
          					echo "<p class='animate__animated animate__fadeOut' style='--animate-duration: 8s;padding:0px;margin-bottom:0px;'><div class='alert alert-success' role='alert'>added to cart</div></p>";
					  else if($addtocart=="no")
          					echo "<p class='animate__animated animate__fadeOut' style='--animate-duration: 8s;padding:0px;margin-bottom:0px;'><div class='alert alert-warning' role='alert'>Not added to cart, try again</div></p>";
       				    ?>
