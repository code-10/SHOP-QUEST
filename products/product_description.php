		...
		<div class="row">
			...
			<div class="col-lg-6 col-xs-2 col-sm-2 col-md-2">
			    ...
			    <?php if($wstate||$astate) 
					echo '<a href="wishlist.php?product_id='.$product_id.'&&product_name='.$product_name.'"> <i class="fa fa-heart"></i></a>';
			    	else
					echo '<a href="wishlist.php?product_id='.$product_id.'&&product_name='.$product_name.'"> <i class="fa fa-heart-o"></i></a>';
			    ?>
		    </h5><br>
