...
<div class="container">
  <div class="text-center">
    <? if($nolog)
          echo "<h4 class='animate__animated animate__fadeOut' style='--animate-duration: 24s;'><div class='alert alert-warning' role='alert'>You are not logged in &nbsp;nbsp;<a href='../login/login.php' style='font-size:16px;'>login</a></div></h4>";
      else if($nostock)
