		...
		<div class="col-lg-10 col-sm-10 col-xs-10 col-md-10 col-6">
			<div class="row">
				...
				<form method="POST" action="cart.php">
					...
					<button type="submit" class="fa fa-minus btn btn-dark btn-sm pm" name="minus" style="background-color:black;color:white;"></button>&nbsp&nbsp<?=$product_qty[$i]?>&nbsp&nbsp<button type="submit" class="fa fa-plus pm" name="plus" style="background-color:black;color:white;"></button>
				</form>
				</div>
