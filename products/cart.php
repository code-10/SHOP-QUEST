...
<?php for($i=0;$i<$n;$i++) { ?>	
	<div class="row m-4 d-flex justify-content-center">
		...
		<div class="col-lg-4 col-sm-4 col-xs-4 col-md-4 col-8">
			<div class="row">
				<div class="col-lg-4 col-sm-4 col-xs-4 col-md-4 col-8"><p style="margin-bottom:0px;"><?=$product_name[$i]?></p></div>
				<div class="col-lg-4 col-sm-4 col-xs-4 col-md-4 col-8"><p style="margin-bottom:0px;">color : <?=$product_color[$i]?></p></div>
				<div class="col-lg-4 col-sm-4 col-xs-4 col-md-4 col-8"><p style="margin-bottom:0px;">size : <?=$product_size[$i]?></p></div>
				<div class="col-lg-4 col-sm-4 col-xs-4 col-md-4 col-8"><p style="margin-bottom:0px;">quantity : <?=$product_qty[$i]?></p></div>
				<div class="col-lg-4 col-sm-4 col-xs-4 col-md-4 col-8"><p style="margin-bottom:0px;">price : <?=$product_qty[$i]*$product_price[$i]?></p></div>
			</div>
		</div>
	</div>
<?php } ?>
