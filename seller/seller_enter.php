...
<body>
  <nav class="navbar navbar-expand-md navbar-dark bg-dark">
	...
	<div class="text-center m-4">
            <a class="btn btn-primary m-2" href="seller_enter.php?my_sell_requests=yes&&show_stat=1" role="button">Pending</a>
	    <a class="btn btn-primary m-2" href="seller_enter.php?my_sell_requests=yes&&show_stat=2" role="button">Approved</a>
            <a class="btn btn-primary m-2" href="seller_enter.php?my_sell_requests=yes&&show_stat=4" role="button">Rejected</a>
	</div>
